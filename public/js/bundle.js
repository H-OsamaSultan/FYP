...
var login = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(email, password, signingup) {
    var spinner, res;
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            if (res.data.status = 'success') window.location = 'http://127.0.0.1:3000';
            _context2.next = 10;
            break;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            if (res.data.status === 'success') {
              ...
              spinner.classList.toggle('hidden');
              (0, _login.login)(email, password, true);
            }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","./login":"login.js"}],"updateSettings.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"home.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.loadPosters = exports.closeModal = void 0;
...
/* eslint-disable */
var loadPosters = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var featuredImg, featuredLink, popularURL, res, data, i, posterPath;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            featuredImg = document.querySelectorAll('.featured__img');
            featuredLink = document.querySelectorAll('.featured__link');
            popularURL = 'https://api.themoviedb.org/3/movie/popular?api_key=3718eda98708443cde931b20b81a12e0&language=en-US&page=1';
            _context.next = 5;
            return fetch("".concat(popularURL));
          ...
          case 8:
            ...
            for (i; i < 6; i += 1) {
              posterPath = "https://image.tmdb.org/t/p/original/".concat(data.results[i].poster_path);
              featuredLink[i].href = "/movie/".concat(data.results[i].id);
  ...
  return function loadPosters() {
    return _ref.apply(this, arguments);
  };
}();

exports.loadPosters = loadPosters;
var login = document.querySelector('.login-section');
var signup = document.querySelector('.signup-section');
var overlay = document.querySelectorAll('.overlay');
var review = document.querySelector('.review-section');
var trailerVideo = document.querySelector('.trailer-video');
var btnOpenLogin = document.querySelectorAll('.login-btn');
var btnOpenSignup = document.querySelector('.signup-btn');
var btnOpenReview = document.querySelector('.review__btn');
var editReviewBtn = document.querySelector('.edit-btn');
var btnOpenTrailer = document.querySelector('.trailer-btn');
...
var openReview = function openReview() {
  review.classList.remove('hidden');
  overlay[1].classList.remove('hidden');
};

var openTrailer = function openTrailer() {
...
exports.loadMovies = exports.findMovies = void 0;
...
function displayMovieList(movies) {
  ...
  for (var i = 0; i < 6; i += 1) {
    if (movies[i]) {
      ...
      movieLink.href = "/movie/".concat(movies[i].id);
      var movieListItem = document.createElement('div');
      movieListItem.dataset.id = movies[i].id; // setting movie id in  data-id

      movieListItem.classList.add('search-list-item');
      var moviePoster = void 0;

      if (movies[i].poster_path !== null) {
        moviePoster = "https://image.tmdb.org/t/p/w154".concat(movies[i].poster_path);
        movieListItem.innerHTML = "\n        <div class = \"search-item-thumbnail\">\n            <img src = \"".concat(moviePoster, "\">\n        </div>\n        <div class = \"search-item-info\">\n            <h3>").concat(movies[i].title, "</h3>\n            <p>").concat(movies[i].release_date.split('-')[0], "</p>\n        </div>\n        ");
      } else {
...
var loadMovies = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(searchQuery) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            URL = "https://api.themoviedb.org/3/search/movie?api_key=3718eda98708443cde931b20b81a12e0&query=".concat(searchQuery, "&page=1&include_adult=true");
            _context.next = 3;
...
},{}],"recommendation.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.sendData = exports.findMoviesRec = exports.displayMovieRecommendations = void 0;
...
var moviesList = document.querySelector('.film__list');
var searchBoxRec = document.querySelector('.search__input-rec');
var searchListRec = document.querySelector('.search-list-rec');

if (searchBoxRec) {
  searchListRec.addEventListener('click', function (e) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "http://127.0.0.1:3000/api/v1/recommendations/".concat(data)
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              displayMovieRecommendations(res.data.data.data); //   showAlert('success', 'successfully!');
            }
...
function displayMovieList(matches) {
  ...
  for (var i = 0; i < 6; i += 1) {
    if (matches[i]) {
      var movieListItem = document.createElement('div');
      movieListItem.innerHTML = "\n            <div class=\"search-list-item\">\n            ".concat(matches[i].original_title, "\n        </div>\n        ");
...
var loadRecList = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(searchQuery) {
    var res, list, matches;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return fetch('../data/films.json');
          ...
          case 5:
            ...
            matches = list.filter(function (movie) {
              ...
              var regex = new RegExp("^".concat(searchQuery), 'gi'); // return data that matches those
  ...
  return function loadRecList(_x2) {
    return _ref2.apply(this, arguments);
  };
}();

var findMoviesRec = function findMoviesRec() {
  var searchQuery = searchBoxRec.value.trim();
...
exports.findMoviesRec = findMoviesRec;

var displayMovieRecommendations = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(movieIDs) {
    var i, resMovie, movieListItem;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 2:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "https://api.themoviedb.org/3/movie/".concat(movieIDs[i], "/images?api_key=3718eda98708443cde931b20b81a12e0")
            });

          case 6:
            resMovie = _context3.sent;

            if (resMovie.data.id && resMovie.data.posters.length > 0) {
              movieListItem = document.createElement('div');
              movieListItem.innerHTML = "<a href=\"/movie/".concat(resMovie.data.id, "\">\n        <div class=\"film__item\">\n        <img class=\"film__img\" src=\"https://image.tmdb.org/t/p/original/").concat(resMovie.data.posters[0].file_path, "\"></div>\n        </a>\n        </div>");
  ...
  return function displayMovieRecommendations(_x3) {
    return _ref3.apply(this, arguments);
  };
}();

exports.displayMovieRecommendations = displayMovieRecommendations;
...
var changeState = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(movieID, state, action) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://127.0.0.1:3000/api/v1/movies/".concat(movieID, "/").concat(state, "/").concat(action)
            });
  ...
  return function changeState(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();

exports.changeState = changeState;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"createMovie.js":[function(require,module,exports) {
"use strict";
...
var createMovie = /*#__PURE__*/function () {
  ...
  return function createMovie(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
var createReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(movieID, review) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "http://127.0.0.1:3000/api/v1/movies/".concat(movieID, "/reviews"),
              data: {
                review: review
              }
            });
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"updateReview.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://127.0.0.1:3000/api/v1/reviews/updatereview/".concat(movieID),
              data: {
                review: review
              }
            });
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"checkReviewExists.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.checkReviewExists = void 0;
...
var checkReviewExists = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(movieID) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "http://127.0.0.1:3000/api/v1/reviews/checkreview/".concat(movieID)
            });
  ...
  return function checkReviewExists(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.checkReviewExists = checkReviewExists;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"checkMovieExists.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.checkMovieExists = void 0;
...
var checkMovieExists = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(movieID) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "http://127.0.0.1:3000/api/v1/movies/checkmovie/".concat(movieID)
            });
  ...
  return function checkMovieExists(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.checkMovieExists = checkMovieExists;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"passwordResetEmail.js":[function(require,module,exports) {
"use strict";
...
// type is either 'password' or 'data'
var passwordResetEmail = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data) {
    var spinner, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            if (res.data.status === 'success') {
              spinner.classList.toggle('hidden');
              (0, _alerts.showAlert)('success', 'We’ve emailed you a link you can use to reset your password.');
            }
  ...
  return function passwordResetEmail(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.passwordResetEmail = passwordResetEmail;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"passwordReset.js":[function(require,module,exports) {
"use strict";
...
var passwordReset = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://127.0.0.1:3000/api/v1/users".concat(data.resetUrl, "/reset"),
              data: data
            });
          ...
          case 5:
            ...
            if (res.data.status === 'success') {
              spinner.classList.toggle('hidden');
              (0, _alerts.showAlert)('success', 'Your password has been reset!');
            }
  ...
  return function passwordReset(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.passwordReset = passwordReset;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"movieFilter.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.movieFilter = void 0;
...
var movieFilter = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(searchQuery, genre, rating, startYear, endYear, language, sortby) {
    var res, i, resMovie, movieListItem;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
          ...
          case 7:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "https://api.themoviedb.org/3/discover/movie?api_key=3718eda98708443cde931b20b81a12e0&with_genres=".concat(genre, "&vote_average.gte=").concat(rating, "&with_original_language=").concat(language, "&sort_by=").concat(sortby, "&primary_release_date.gte=").concat(startYear, "&primary_release_date.lte=").concat(endYear)
            });
          ...
          case 13:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "https://api.themoviedb.org/3/movie/".concat(res.data.results[i].id, "/images?api_key=3718eda98708443cde931b20b81a12e0")
            });
  ...
  return function movieFilter(_x, _x2, _x3, _x4, _x5, _x6, _x7) {
    return _ref.apply(this, arguments);
  };
}();
...
var _createMovie = require("./createMovie");

var _createReview = require("./createReview");

var _updateReview = require("./updateReview");

var _checkReviewExists = require("./checkReviewExists");

var _checkMovieExists = require("./checkMovieExists");

var _passwordResetEmail = require("./passwordResetEmail");
...
var resetRequestEmailForm = document.querySelector('.form-reset-request-email');
var resetPasswordForm = document.querySelector('.form-reset-password');
var userPasswordForm = document.querySelector('.form-user-password');
var featuredImg = document.querySelectorAll('.featured__img');
var searchBox = document.querySelector('.search__input');
var searchBoxRec = document.querySelector('.search__input-rec');
var searchList = document.querySelector('.search-list');
var searchListRec = document.querySelector('.search-list-rec');
var watchedBtn = document.querySelector('.watched');
var likedBtn = document.querySelector('.liked');
var watchlistBtn = document.querySelector('.watchlist');
var iconWatched = document.querySelector('.icon-watched');
var iconLiked = document.querySelector('.icon-liked');
var iconWatchlist = document.querySelector('.icon-watchlist');
var details = document.querySelector('.details');
var ratings = document.querySelector('.rating-group');
var submitReviewBtn = document.querySelector('.Rev_btn');
var ratingNone = document.querySelector('.rating--none');
var header = document.querySelector('.header');
var filmHeader = document.querySelector('.film__header');
var btnMovieFilter = document.querySelector('.btn-movie-filter');
var filterOptions = document.getElementsByTagName('select');
var filterInput = document.querySelector('.search-term-input');

if (btnMovieFilter) {
  btnMovieFilter.addEventListener('click', function (e) {
    var searchQuery = filterInput.value;
    var genre = filterOptions[0].options[filterOptions[0].selectedIndex].value;
    var rating = filterOptions[1].options[filterOptions[1].selectedIndex].value;
    var startYear = filterOptions[2].options[filterOptions[2].selectedIndex].value;
    var endYear = String(Number(startYear.split('-')[0]) + 9) + '-01-01';
    var language = filterOptions[3].options[filterOptions[3].selectedIndex].value;
    var sortby = filterOptions[4].options[filterOptions[4].selectedIndex].value;
    (0, _movieFilter.movieFilter)(searchQuery, genre, rating, startYear, endYear, language, sortby);
  });
}

var changeRating = function changeRating() {
  var rate = JSON.parse(ratings.dataset.rate);
  var ratingChecked = document.getElementById("rating-".concat(rate));
...
if (ratings) {
  ...
  ratings.addEventListener('mouseover', function (e) {
    ratingNone.style.opacity = 1;
  });
  ratings.addEventListener('mouseout', function (e) {
    ratingNone.style.opacity = 0;
  });
  ratings.addEventListener('change', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              movieID = JSON.parse(details.dataset.movieid);
              _context.next = 3;
              return (0, _checkMovieExists.checkMovieExists)(movieID);

            case 3:
              status = _context.sent;

              if (!status.data.exists) {
                (0, _createMovie.createMovie)(movieID);
              }

              (0, _action.changeState)(movieID, e.target.value, 'rating');
...
if (submitReviewBtn) {
  submitReviewBtn.addEventListener('click', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
      var movieID, status, review, movieData, reviewStatus;
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
            ...
            case 5:
              ...
              review = document.getElementById('text_area').value;
              ...
              _context2.next = 10;
              return (0, _createMovie.createMovie)(movieID);

            case 10:
              movieData = _context2.sent;
              (0, _createReview.createReview)(movieData.data.data.movieID, review);
              _context2.next = 18;
              break;

            case 14:
              _context2.next = 16;
              return (0, _checkReviewExists.checkReviewExists)(movieID);

            case 16:
              reviewStatus = _context2.sent;

              if (!reviewStatus.data.exists) {
                (0, _createReview.createReview)(movieID, review);
              } else {
                (0, _updateReview.updateReview)(movieID, review);
              }
...
if (filmHeader) {
  header.style.backgroundImage = "linear-gradient(90deg, #14181c 0%, rgba(255, 255, 255, 0) 15%, rgba(255, 255, 255, 0) 85%, #14181c 100%), linear-gradient(0deg, #14181c 0%, rgba(255, 255, 255, 0) 30%, rgba(255, 255, 255, 0) 80%, rgba(0, 0, 0, 0.5) 100%), url(".concat(filmHeader.dataset.moviebackdrop, ")");
}

if (watchedBtn) {
  watchedBtn.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
    var movieID, status;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (iconWatched.classList.contains('fill')) {
              (0, _action.changeState)(movieID, false, 'watched');
              document.querySelector('.watched-para').innerText = 'Watch';
            } else {
              (0, _action.changeState)(movieID, true, 'watched');
...
if (likedBtn) {
  likedBtn.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
    var movieID, status;
        ...
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            if (iconLiked.classList.contains('fill')) {
              (0, _action.changeState)(movieID, false, 'liked');
            } else {
              (0, _action.changeState)(movieID, true, 'liked');
            }
...
if (watchlistBtn) {
  watchlistBtn.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
    var movieID, status;
        ...
        switch (_context5.prev = _context5.next) {
          ...
          case 3:
            ...
            if (iconWatchlist.classList.contains('fill')) {
              (0, _action.changeState)(movieID, false, 'watchlist');
            } else {
              (0, _action.changeState)(movieID, true, 'watchlist');
            }
...
if (loginForm) loginForm.addEventListener('submit', function (e) {
  ...
  (0, _login.login)(email, password, false);
});
...
if (resetRequestEmailForm) resetRequestEmailForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var email = document.getElementById('email').value;
  (0, _passwordResetEmail.passwordResetEmail)({
    email: email
  });
});
if (resetPasswordForm) resetPasswordForm.addEventListener('submit', function (e) {
  ...
  (0, _passwordReset.passwordReset)({
    password: password,
    passwordConfirm: passwordConfirm,
    resetUrl: resetUrl
  });
...
if (searchBoxRec) {
  searchBoxRec.addEventListener('keyup', function () {
    (0, _recommendation.findMoviesRec)();
  });
